...
public class ColorFliterRenderPass : ScriptableRenderPass
{
    // private static readonly int intensityId =
    //     Shader.PropertyToID("_Intensity");

    private RedTintSettings defaultSettings;
    private Material material;

    private RenderTextureDescriptor textureDescriptor;
    private RTHandle textureHandle;

    public ColorFliterRenderPass(Material material, RedTintSettings defaultSettings)
    {
